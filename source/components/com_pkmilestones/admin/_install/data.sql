...
VALUES(
	'Projectknife Milestone', 
	'com_pkmilestones.milestone', 
	'{"special":{"dbtable":"#__pk_milestones","key":"id","type":"Milestone","prefix":"PKMilestonesTable","config":"array()"},"common":{"dbtable": "#__ucm_content","key": "ucm_id","type": "Corecontent","prefix": "JTable","config": "array()"}}', 
	'', 
