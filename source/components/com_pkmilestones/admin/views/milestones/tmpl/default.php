...
if ($list_order == 'a.ordering' || $list_order == 'ordering') {
    $order_url = 'index.php?option=com_pkmilestones&task=milestones.saveOrderAjax&tmpl=component';
    JHtml::_('sortablelist.sortable', 'milestoneList', 'adminForm', strtolower($list_dir), $order_url);
}
...
JFactory::getDocument()->addScriptDeclaration('
    ...
    {
        if (task == "milestones.copy_dialog") {
