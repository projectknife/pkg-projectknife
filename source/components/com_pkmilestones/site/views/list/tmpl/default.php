...
<div class="grid milestone-list">
    ...
    <form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_pkmilestones&view=list&Itemid=' . PKApplicationHelper::getMenuItemId('active')); ?>" method="post">
        <?php
        // Toolbar
        echo $this->toolbar;
