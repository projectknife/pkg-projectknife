...
for ($i = 0; $i != $count; $i++)
{
    ...
    // Format project
    $project = $txt_project . ': <a href="' . JRoute::_($url_list . '&filter_project_id=' . $item->project_id) . '">'
             . $this->escape(($item->project_title == '' ? '-' : $item->project_title)) . '</a>';
    ...
    ?>
    <div class="row-fluid milestoneItem" id="milestone-<?php echo $item->id; ?>" sortable-group-id="<?php echo $item->project_id; ?>">
        <div class="span12">
            <div class="row-fluid">
                <div class="span12">
                    <h3 class="item-title">
                        <?php echo $btn_select . $btn_order . $title;?>
            ...
            <div class="row-fluid">
                ...
                <div class="span2">
                    <div class="thumbnail center">
                        <a class="btn btn-link span12" href="<?php echo JRoute::_($url_tasks . '&filter_project_id=' . $item->project_id . '&filter_milestone_id=' . $item->id); ?>">
                            <?php echo $txt_tasks; ?>
                        </a>
                        <div class="clearfix"></div>
