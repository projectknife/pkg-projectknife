...
// Get auto-access config setting
...
$categories = array_merge(
    array(JHtml::_('select.option', '', '- ' . JText::_('COM_PKPROJECTS_COPY_KEEP_CATEGORY') . ' -')),
...
$levels = array_merge(
    array(JHtml::_('select.option', '', '- ' . JText::_('PKGLOBAL_KEEP_ACCESS') . ' -')),
    $this->get('AccessOptions')
);
