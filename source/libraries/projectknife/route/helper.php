...
abstract class PKRouteHelper
{
    ...
    /**
     * Looks up menu items of a specific component
     *
     ...
     * @return    void
     */
    protected static function lookup($component, $language)
    {
    ...
    public static function getMenuItemId($component, $view = null, $needles = null)
    {
        ...
        if (!isset(self::$menu_items[$component])) {
            self::lookup($component, $language);
        }
...
$default        = $menus->getDefault($language);
    ...
    /**
     * Method to count the menu items of a component and view
     *
     * @param     string     $component
     * @param     string     $view
     * @param     array      $needles
     ...
     * @return    integer
     */
    public static function getMenuItemCount($component, $view = null, $needles = null)
    {
        $language = '*';
